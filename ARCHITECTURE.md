...
- UE5 구현에서 C++ 비중과 Blueprint 비중의 최종 기준
- Data Asset과 Data Table 중 카드 데이터 최종 저장 방식
- 필살기 조건 UI를 파티원 패널에 둘지, 행동 큐에 둘지
- 스테이지 그리드 생성이 고정형인지 랜덤형인지
- 저장/로드를 최초 마스터에 최소 포함할지 여부
